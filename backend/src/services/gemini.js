...
async function analyzeContract(contractText) {
  const prompt = `Ты юридический аналитик, специализирующийся на казахстанском бизнес-праве.
Проанализируй следующий договор и предоставь ответ СТРОГО в JSON формате. 
Если документ на казахском языке — пиши значения в JSON на казахском, если на русском — на русском, если на английском — на английском.
Используй язык, на котором написана большая часть договора.

{
  "summary": "краткое резюме договора (2-3 предложения)",
  "keyTerms": ["ключевое условие 1", "ключевое условие 2", "..."],
...
Отвечай ТОЛЬКО JSON, без markdown блоков, без объяснений.`;
